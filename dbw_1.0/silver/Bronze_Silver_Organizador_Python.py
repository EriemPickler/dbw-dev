...
#Diretorio de origem
bronze_path_organizador = "/mnt/bronze/csv/organizador.csv"

#Diretorio de destino
silver_path_deltaTable = "/mnt/silver/db/organizador/"
deltaTable = "silver.organizador"
...
organizadorDF = organizadorDF.withColumn('Updated_Date', lit(''))
...
delta_organizadorDF = DeltaTable.forName(spark, deltaTable)
...
organizadorDF.write.mode('append').format('delta').partitionBy('Partition_Date').saveAsTable(deltaTable)
