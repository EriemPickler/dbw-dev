...
#Diretorio de origem
bronze_path_estilo_musical = "/mnt/bronze/csv/estilo_musical.csv"
 
#Diretorio de destino
silver_path_deltaTable = "/mnt/silver/db/estilo_musical/"
deltaTable = "silver.estilo_musical"
...
estilo_musicalDF = estilo_musicalDF.withColumn('Updated_Date', lit(''))
...
delta_estilo_musicalDF = DeltaTable.forName(spark, deltaTable)
...
estilo_musicalDF.write.mode('append').format('delta').partitionBy('Partition_Date').saveAsTable(deltaTable)
