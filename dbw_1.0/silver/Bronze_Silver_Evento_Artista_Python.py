...
#Diretorio de origem
bronze_path_evento_artista = "/mnt/bronze/csv/evento_artista.csv"
 
#Diretorio de destino
silver_path_deltaTable = "/mnt/silver/db/evento_artista/"
deltaTable = "silver.evento_artista"
...
evento_artistaDF = evento_artistaDF.withColumn('Updated_Date', lit(''))
...
delta_evento_artistaDF = DeltaTable.forName(spark, deltaTable)
...
evento_artistaDF.write.mode('append').format('delta').partitionBy('Partition_Date').saveAsTable(deltaTable)
