...
#Diretorio de origem
bronze_path_telefone = "/mnt/bronze/csv/telefone.csv"

#Diretorio de destino
deltaTable = "silver.telefone"
...
telefoneDF = telefoneDF.withColumn('Updated_Date', lit(''))
...
delta_telefoneDF = DeltaTable.forName(spark, deltaTable)
...
telefoneDF.write.mode('append').format('delta').partitionBy('Partition_Date').saveAsTable(deltaTable)
