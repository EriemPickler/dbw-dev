...
#Diretorio de origem
bronze_path_artista = "/mnt/bronze/csv/artista.csv"

#Diretorio de destino
deltaTable = "silver.artista"
...
tempView_artistaPythonDF = spark.table("tempView_artistaSQL")
...
delta_artistaDF = DeltaTable.forName(spark, deltaTable)
...
# MAGIC %sql
# MAGIC 
# MAGIC select * from silver.artista

# COMMAND ----------

# DBTITLE 1,Inserindo dados na tabela - python
artistaDF.write.mode('append').format('delta').partitionBy('Partition_Date').saveAsTable(deltaTable)

# COMMAND ----------

#part-00000-e37b30c2-523f-40fe-ab14-132891f3b330.c000.snappy.parquet
