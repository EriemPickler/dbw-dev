...
#Diretorio de origem
silver_path_local = f"/mnt/silver/db_gen/localizacao/"

#Diretorio de destino
gold_path_SQL = "/mnt/gold/db_gen/dim_local/"
...
# MAGIC %sql
# MAGIC 
# MAGIC MERGE INTO gold_gen.dim_local as tb
...
# MAGIC %sql
# MAGIC 
# MAGIC select * from gold_gen.dim_local
...
# MAGIC select *
# MAGIC FROM
# MAGIC   delta.`/mnt/gold/db_gen/dim_local`

# COMMAND ----------

display(spark.table("gold_gen.dim_local"))
