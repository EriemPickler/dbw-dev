...
gold_path_Python = "/mnt/gold/db_gen/dim_organizador/"


#Diretorio de origem
silver_path_organizador = f"/mnt/silver/db_gen/organizador/"
silver_path_telefone = f"/mnt/silver/db_gen/telefone/"

#Diretorio de destino
gold_path_deltaTable = "/mnt/gold/db_gen/dim_organizador/"
...
organizadorDF = spark.table("silver.organizador").filter("Updated_Date = ''")
...
telefoneDF = spark.table("silver.telefone").filter("Updated_Date = ''")
...
# MAGIC %sql
# MAGIC 
# MAGIC select * from gold_gen.dim_organizador
